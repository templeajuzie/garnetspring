  ...
  return (
    <div>
      <div className="max-w-3xl px-16 mx-auto mt-4 mb-8 text-center md:mb-12 lg:mb-5">
        <h2 className="text-3xl font-bold md:text-3xl">Our Offerings</h2>
          ...
          <div className="py-8 transition-all shadow-md mb-9 rounded-xl px-7 hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
              ...
              <p className="text-base font-medium text-body-color">
                We use high-quality materials and manufacturing processes to
                produce packaging that is durable, long-lasting and we adhere to
        ...
        <div className="w-full px-4 md:w-1/2 lg:w-1/3">
          <div className="py-8 transition-all shadow-md mb-9 rounded-xl px-7 hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
              ...
              <p className="text-base font-medium text-body-color">
                We have the expertise to design and manufacture packaging that
        ...
        <div className="w-full px-4 md:w-1/2 lg:w-1/3">
          <div className="py-8 transition-all shadow-md mb-9 rounded-xl px-7 hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
              ...
              <p className="text-base font-medium text-body-color">
                We work with our clients to understand their budget and to find
                the best possible solution for their needs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full px-4 md:w-1/2 lg:w-1/3">
          <div className="py-8 transition-all shadow-md mb-9 rounded-xl px-7 hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
              ...
              <p className="text-base font-medium text-body-color">
                We use FSC-certified paper and recycled paper, also we offer
                on-demand production, which helps to reduce waste.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full px-4 md:w-1/2 lg:w-1/3">
          <div className="py-8 transition-all shadow-md mb-9 rounded-xl px-7 hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
              ...
              <p className="text-base font-medium text-body-color">
                By effectively communicating their sustainability efforts and
                values, brands can not only strengthen their market position but
                also contribute to a more sustainable and environmentally
                responsible future.
              </p>
            </div>
          </div>
        ...
        <div className="w-full px-4 md:w-1/2 lg:w-1/3">
          <div className="py-8 transition-all shadow-md mb-9 rounded-xl px-7 hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            ...
            <div>
              ...
              <p className="text-base font-medium text-body-color">
                We are happy to include a barcode system as part of the
                packaging service that enable your customers to scan for easy
                access to your website, social media profiles, referral system
                and the option to provide feedback.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="inline-block mx-auto mb-7">
              ...
              >
                <path
                  ...
                  fill="#6A64F1"
                ></path>
                <circle cx="25.5" cy="39" r="8" fill="#ABA8F7" />
              </svg>
            </div>
            <div>
              <h3 className="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">
              ...
              <p className="text-base font-medium text-body-color">
                We offer a robust referral system that allow your customers to
                refer your business to others for a reward, increasing your
                reach and sales.
              </p>
            </div>
          </div>
