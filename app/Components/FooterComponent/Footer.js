    ...
    <footer className="relative w-full mt-2 bg-[#11113A]">
      <div className="px-4 mt-24 border-t border-gray-900 border-opacity-10 lg:px-24">
        <div className="flex justify-center pt-16">
          ...
          >
            <Image
              className="h-[65px] w-auto object-cover "
              src={logo}
              height={200}
              width={200}
              alt=""
        ...
        <div className="w-full px-8 mx-auto max-w-7xl">
          ...
          <div className="flex flex-col items-center justify-center w-full py-4 border-t border-blue-gray-50 md:flex-row md:justify-between">
            <Typography
              variant="small"
              className="mb-4 font-normal text-center text-blue-gray-100 md:mb-0"
            >
              &copy; {currentYear}{" "}
              <a href="https://material-tailwind.com/">Garnet Spring</a>. All
              Rights Reserved.
            </Typography>
